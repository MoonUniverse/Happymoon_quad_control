...
Eigen::Quaterniond GeometryEigenConversions::geometryToEigen(
    const geometry_msgs::msg::Quaternion &vec_ros) {
...
GeometryEigenConversions::eigenToGeometry(const Eigen::Quaterniond &vec_eigen) {
  geometry_msgs::msg::Quaternion vec_ros;
...
Eigen::Vector3d GeometryEigenConversions::geometryToEigen(
    const geometry_msgs::msg::Vector3 &vec_ros) {
...
Eigen::Vector3d
GeometryEigenConversions::geometryToEigen(const geometry_msgs::msg::Point &vec_ros) {
  Eigen::Vector3d vec_eigen;
  vec_eigen.x() = vec_ros.x;
  vec_eigen.y() = vec_ros.y;
  vec_eigen.z() = vec_ros.z;
...
GeometryEigenConversions::eigenToGeometry(const Eigen::Vector3d &vec_eigen) {
  geometry_msgs::msg::Vector3 vec_ros;
  vec_ros.x = vec_eigen.x();
  vec_ros.y = vec_eigen.y();
  vec_ros.z = vec_eigen.z();
  return vec_ros;
...
GeometryEigenConversions::vectorToPoint(const geometry_msgs::msg::Vector3 &vector) {
...
Eigen::Affine3d
GeometryEigenConversions::geometryToEigen(const geometry_msgs::msg::Pose &pose_ros) {
  Eigen::Affine3d pose;
